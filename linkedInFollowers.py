...
#login button
loginBtn=browser.find_element_by_xpath('/html/body/div/main/div[2]/form/div[3]/button')
loginBtn.click()
...
#an element at the top of the page where number of followers is written
nOF=browser.find_element_by_id("ember47")

#consists of several words but we require only the number of followers
nf=int(nOF.text.split(" ")[0])
print(nf)
...
if(Path('C:\\Users\\91970\\Desktop\\LinkedIn_Followers.xlsx').exists()):
        ...
        workbook=openpyxl.load_workbook('C:\\Users\\91970\\Desktop\\LinkedIn_Followers.xlsx')
        ...
        print("Number of columns= %d and entries in last column= %d"%(numberOfColumns,lengthOfLastColumn))
